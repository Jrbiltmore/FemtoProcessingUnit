...
# fpu/src/ai/AI_Models.py (continued)
...
# Utility function for initializing model weights
def weights_init(m):
...
# The following block definition is for ResNet and must be defined elsewhere in your code
